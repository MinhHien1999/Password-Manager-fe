...
async function getAccountByCategoryId() {
  if (!CATEGORY_ID) window.location.href = "categories.html";

  const response = await fetch(`https://password-manager-yakc.onrender.com/category/${CATEGORY_ID}`);
...
function createElementAccount(data) {
  ...
  tr.innerHTML = `
                ...
                <td class="text-center">
                    ...
                    <a href="account-edit.html?id=${data._id}" class="btn btn-sm btn-primary">
